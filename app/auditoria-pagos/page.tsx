...
export default function PaymentAuditPage() {
  ...
  if (!isAdminSession(session)) return <main className="min-h-screen bg-slate-100 p-4 text-slate-900"><section className="mx-auto max-w-5xl rounded-3xl border bg-white p-5 shadow-sm">La <b>auditoría de pagos</b> es una herramienta de control global disponible solo para administración.</section></main>;
