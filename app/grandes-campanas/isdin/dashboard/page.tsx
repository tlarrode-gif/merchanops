...
import { AppSession, canAccessModule, canViewGlobalDashboards, filterBySessionProvince, getCurrentAppSession } from "@/lib/access-control";
...
export default function IsdinDashboardPage() {
  ...
  // Dashboard global del cliente: visible solo para administración (también por URL directa).
  ...
  if (!canViewGlobalDashboards(session)) return <main className="min-h-screen bg-slate-100 p-4 text-slate-900"><section className="mx-auto mt-10 max-w-2xl rounded-3xl border bg-white p-5 shadow-sm">El <b>dashboard global de KPIs ISDIN</b> solo está disponible para administración. <a className="underline" href="/grandes-campanas/isdin">Volver a ISDIN</a>.</section></main>;
